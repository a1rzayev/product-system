...
export default function CustomerNewProductPage() {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        if (response.status === 401) {
          throw new Error('You are not authorized. Please log in as a customer.')
    ...
    <div className="space-y-6">
      ...
      <form onSubmit={handleSubmit} className="bg-white shadow rounded-lg p-6 space-y-6">
        ...
        <div>
          ...
          {images.length > 0 && (
            <div className="mt-4">
              <h4 className="text-sm font-medium text-black mb-2">Selected Images ({images.length})</h4>
