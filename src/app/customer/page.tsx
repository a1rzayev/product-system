    ...
    return (
      <div className="space-y-6">
        <div>
          ...
          <p className="text-gray-600">Welcome to your product management panel</p>
        </div>
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-600">
          Welcome back, {session?.user?.name || session?.user?.email}! Manage your products here.
        </p>
      </div>
