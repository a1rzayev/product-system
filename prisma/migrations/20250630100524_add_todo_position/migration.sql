...
INSERT INTO "new_todos" ("assignedTo", "createdAt", "createdBy", "description", "dueDate", "id", "isCompleted", "priority", "status", "title", "updatedAt") SELECT "assignedTo", "createdAt", "createdBy", "description", "dueDate", "id", "isCompleted", "priority", "status", "title", "updatedAt" FROM "todos";
DROP TABLE "todos";
